 ...
 * the same /server/osai_mcp_api path the client's api.js expects by default.
 */
...
app.use('/server/osai_mcp_api', functionApp);

app.listen(PORT, () => {
  console.log(`Osai MCP Control Center (local dev) running on port ${PORT}`);
});
